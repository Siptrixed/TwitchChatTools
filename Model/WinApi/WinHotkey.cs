...
namespace TwitchChatTools.Model.WinApi
{
    public class WinHotkey : IDisposable
    {
        ...
        public bool Register()
        {
            ...
            if (_dictHotKeyToCalBackProc?.ContainsKey(Id) ?? false) return false;
        ...
        public bool Unregister()
        {
            if (_dictHotKeyToCalBackProc!.TryGetValue(Id, out _))
            {
                ...
                return UnregisterHotKey(nint.Zero, Id);
            }
            return false;
        }
        ...
        private static void ComponentDispatcherThreadFilterMessage(ref MSG msg, ref bool handled)
        {
            if (!handled)
            {
                ...
                {
                    if (_dictHotKeyToCalBackProc!.TryGetValue((int)msg.wParam, out WinHotkey? hotKey))
                    {
